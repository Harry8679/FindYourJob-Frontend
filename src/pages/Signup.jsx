                ...
                <div className="grid grid-cols-1">
                  ...
                  <div className="mb-4">
                    <div className="flex items-center mb-0">
                      <input className="form-checkbox size-4 border border-gray-200 dark:border-gray-800 accent-green-600 me-2" type="checkbox" id="AcceptTAC" />
                      <label htmlFor="AcceptTAC" className="text-slate-400">I Accept <a href="#" className="text-emerald-600">Terms And Condition</a></label>
                    </div>
                  </div>

                  <div className="mb-4">
                    <input type="submit" className="py-1 px-5 w-full font-semibold bg-emerald-600 hover:bg-emerald-700 border border-emerald-600 hover:border-emerald-700 text-white rounded-md" value="Register" />
                  </div>
